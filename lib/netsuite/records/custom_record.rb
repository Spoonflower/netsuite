module NetSuite
  module Records
    class CustomRecord
      ...
      actions :get, :update, :get_list, :add, :delete, :search, :upsert, :upsert_list
      ...
      fields :allow_attachments, :allow_inline_editing, :allow_numbering_override, :allow_quick_search, :created,
        ...
        :show_last_modified, :show_notes, :show_owner, :show_owner_allow_change, :show_owner_on_list, :use_permissions, :null_field_list
